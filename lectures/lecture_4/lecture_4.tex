...
\begin{gather*}
    ...
    \implies -y+x=2a_2x\dot{x}+3a_3x^2\dot{x}+\text{ HOT}\\
    \implies -h(x)+x=2a_2x\dot{x}+3a_3x^2\dot{x}+\text{ HOT}\\
    \implies -\left(a_2x^2+a_3x^3\right)+x=2a_2x\dot{x}+3a_3x^2\dot{x}+O(x^4)
\end{gather*}
