...
\[ T_pM_1 + T_pM_2=\mathbb{R}^n \]
Which means that two manifolds ``transversally intersect'' if they intersect in a non parallel fashion. Like, two perpendicular lines intersect transversally, but two parallel lines don't. \textit{Sasha note: we want the span of the union at the intersection, not just of the union of the intersection.}
